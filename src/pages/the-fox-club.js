...
class TheFoxClubPage extends React.Component {
  render() {
    ...
    return (
      <>
        <Helmet>
          ...
          <meta property="og:title" content="the-fox-club-overview" />
        ...
        {thefoxclub.map(({ node }) => {
          return (
            <>
              ...
              <Breadcrumb pageName="THE FOX CLUB" />
...
export default TheFoxClubPage

export const pageQuery = graphql`
  query TheFoxClubQuery {
  allContentfulPages(filter: {id: {eq: "a9fba541-d4eb-59e2-acc9-12132641cfdd"}}) {
    edges {
      node {
        bannerContent
        bannerLink
  ...
  contentfulConfiguration {
    contactFormBackground {
      ...
      contentfulPages(id: {eq: "a9fba541-d4eb-59e2-acc9-12132641cfdd"}) {
    seoMetaKeywords
    seoMetaTitle
    seometaDescription
    contactForm
