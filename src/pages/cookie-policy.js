...
export const pageQuery = graphql`
  ...
  allContentfulPages(filter: {id: {eq: "4891cf9b-12f5-52c8-97d6-515377a84417"}}) {
    edges {
      node {
        bannerContent
        bannerLink
  ...
  contentfulConfiguration {
    ...
    contentfulPages(id: {eq: "4891cf9b-12f5-52c8-97d6-515377a84417"}) {
    seoMetaKeywords
    seoMetaTitle
    seometaDescription
        contactForm
