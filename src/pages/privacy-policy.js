...
class PrivacyPolicyPage extends React.Component {
  render() {
    const PrivacyPolicyPage = get(this, 'props.data.allContentfulPages.edges')
...
export const pageQuery = graphql`
  ...
  allContentfulPages(filter: {id: {eq: "ba30d645-1213-5ae9-b357-1919cdbc21ab"}}) {
    edges {
      node {
        bannerContent
        bannerLink
  ...
  contentfulConfiguration {
    ...
    contentfulPages(id: {eq: "ba30d645-1213-5ae9-b357-1919cdbc21ab"}) {
    seoMetaKeywords
    seoMetaTitle
    seometaDescription
        contactForm
