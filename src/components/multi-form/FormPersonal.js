...
export class FormPersonal extends React.Component {
                        ...
                        <Row>
                            <Col lg={12}>
                                <ul className="list-inline list-pass">
                                    <li className="list-inline-item active"><span>1</span> Personal</li>
                        ...
                        <Container>
                            <Row className="mb-4">
                                <Col lg={6} className="pr-lg-4">
                                    ...
                                    <div className="mb-5">
                                        <Row className="mb-5">
                                            <Col lg={6} className="mb-lg-0 mb-5">
                                                <input type="text" className="form-control" id="" placeholder="Surname" />
                                            </Col>
                                            <Col lg={6}>
                                                <select className="form-control select">
                                        ...
                                        <Row>
                                            <Col lg={6} className="mb-lg-0 mb-5">
                                                <Datetime input={ true } className="form-date" timeFormat={false} inputProps={{ placeholder: 'Date of Birth (MM/DD/YY)' }} />
                                            </Col>
                                            <Col lg={6}>
                                                <select className="form-control select">
                                    ...
                                    <div className="mb-5">
                                        <input type="text" className="form-control" id="" placeholder="Occupation" />
                                    </div>
                                </Col>

                                <Col lg={6} className="pl-lg-4">
                                    <div className="mb-5">
                                        <input type="text" className="form-control" id="" placeholder="Home Address" />
                                    </div>
